...
{
	public class QAEnvStack:PFStackBase
	{
        const string ecsLBCertArn = "arn:aws:acm:eu-west-2:316656599330:certificate/453be658-eec5-4028-8a7b-56677330c11c";
        const string ercRepo = "316656599330.dkr.ecr.eu-west-2.amazonaws.com/jwt-qa-fe-repo:latest";

        public QAEnvStack(Construct scope, PFStackProps stackProps)
            : base(scope, stackProps.StackName, stackProps)
        {
            ...
            // Creating VPC
            Vpc vpc = this.CreateVpc(Constants.QAENV_VPC_CIDR);
            ...
            string cdnId = resourcePrefix + "-cdn";
            CloudFrontWebDistribution cdn = this.CreateCloudFrontWebDistribution(cdnId, ecsALB.LoadBalancerDnsName);


            //var certt = Amazon.CDK.AWS.CertificateManager.Certificate.FromCertificateArn(this, "test", ecsLBCertArn);
            //ViewerCertificate cert = ViewerCertificate.FromAcmCertificate(certt, new ViewerCertificateOptions
            //{
            ...
            //CloudFrontWebDistribution tmpCdn = new CloudFrontWebDistribution(this, "asdasdf", new CloudFrontWebDistributionProps
            //{
            ...
            //            {
            //                 DomainName = ecsALB.LoadBalancerDnsName,
